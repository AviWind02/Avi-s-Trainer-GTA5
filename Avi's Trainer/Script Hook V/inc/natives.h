...
namespace FILES
{
	...
	static void _GET_VARIANT_PROP(Any p0, Any p1, Any p2, Any p3, Any p4) { invoke<Void>(0xD81B7F27BC773E66, p0, p1, p2, p3, p4); } // 0xD81B7F27BC773E66 b791
	...
	static Any GET_SHOP_PED_APPAREL_FORCED_PROP_COUNT(Any p0) { return invoke<Any>(0x017568A8182D98A6, p0); } // 0x017568A8182D98A6 0xC560D7C0 b323
	...
	static void GET_FORCED_PROP(Any p0, Any p1, Any* p2, Any* p3, Any* p4) { invoke<Void>(0xE1CA84EBF72E691D, p0, p1, p2, p3, p4); } // 0xE1CA84EBF72E691D 0x22DAE257 b323
	static BOOL DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Hash componentHash, Hash drawableSlotHash, int componentId) { return invoke<BOOL>(0x341DE7ED1D2A1BFD, componentHash, drawableSlotHash, componentId); } // 0x341DE7ED1D2A1BFD 0x8E2C7FD5 b323
...
namespace HUD
{
	...
	static void BEGIN_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(const char* text) { invoke<Void>(0x54CE8AC98E120CAB, text); } // 0x54CE8AC98E120CAB 0x51E7A037 b323
	static float END_TEXT_COMMAND_GET_SCREEN_WIDTH_OF_DISPLAY_TEXT(BOOL p0) { return invoke<float>(0x85F061DA64ED2F67, p0); } // 0x85F061DA64ED2F67 0xD12A643A b323
	...
	static int END_TEXT_COMMAND_GET_NUMBER_OF_LINES_FOR_STRING(float x, float y) { return invoke<int>(0x9040DFB09BE75706, x, y); } // 0x9040DFB09BE75706 0xAA318785 b323
...
namespace NETSHOPPING
{
	...
	static BOOL NET_GAMESERVER_TRANSACTION_IN_PROGRESS() { return invoke<BOOL>(0x613F125BA3BD2EB9); } // 0x613F125BA3BD2EB9 b372
	...
	static BOOL NET_GAMESERVER_BASKET_IS_ACTIVE() { return invoke<BOOL>(0xA65568121DF2EA26); } // 0xA65568121DF2EA26 b323
	static BOOL NET_GAMESERVER_BASKET_END() { return invoke<BOOL>(0xFA336E7F40C0A0D0); } // 0xFA336E7F40C0A0D0 b372
	...
	static BOOL CHECK_TRANSACTION_PENDING(int transactionId) { return invoke<BOOL>(0xC830417D630A50F9, transactionId); } // 0xC830417D630A50F9 b1365
	static BOOL CHECK_TRANSACTION_FAILED(int transactionId) { return invoke<BOOL>(0x79EDAC677CA62F81, transactionId); } // 0x79EDAC677CA62F81 b1365
...
namespace NETWORK
{
	...
	static Player NETWORK_GET_HOST_OF_SCRIPT(const char* scriptName, int instanceId, int positionHash) { return invoke<Player>(0x1D6A14F1F9A736FC, scriptName, instanceId, positionHash); } // 0x1D6A14F1F9A736FC 0x9C95D0BB b323
	...
	static BOOL NETWORK_ACCESS_TUNABLE_BOOL_MODIFICATION_DETECTION_REGISTRATION_HASH(Hash contextHash, Hash nameHash, BOOL* value) { return invoke<BOOL>(0x697F508861875B42, contextHash, nameHash, value); } // 0x697F508861875B42 b393
...
namespace PAD
{
	...
	static BOOL IS_USING_CURSOR(int padIndex) { return invoke<BOOL>(0x13337B38DB572509, padIndex); } // 0x13337B38DB572509 b323
...
namespace PED
{
	...
	static void DISABLE_PED_INJURED_ON_GROUND_BEHAVIOUR(Ped ped) { invoke<Void>(0x733C87D4CE22BEA2); } // 0x733C87D4CE22BEA2 0x43709044 b323
...
namespace SCRIPT
{
	...
	static int GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(Hash scriptHash) { return invoke<int>(0x2C83A9DA6BFFC4F9, scriptHash); } // 0x2C83A9DA6BFFC4F9 0x029D3841 b323
...
namespace STATS
{
	...
	static Any STAT_GET_CURRENT_SKYDIVING_DISTANCE() { return invoke<Any>(0xAFF47709F1D5DCCE); } // 0xAFF47709F1D5DCCE b463
...
namespace VEHICLE
{
	...
	static void _SET_VEHICLE_ENGINE_POWER_MULTIPLIER(Vehicle vehicle, float value) { invoke<Void>(0xB59E4BD37AE292DB, vehicle, value); } //0xB59E4BD37AE292DB 0x642DA5AA
