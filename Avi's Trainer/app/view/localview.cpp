	...
	namespace local {
		...
		void View()
		{
            {//Health Options
                ...
                buttons::Option("Refill Armour", &feature::local::Refill::tickRefillArmourBarLooped);
                buttons::Toggle("Loop Max Armour", &feature::local::Refill::tickRefillArmourBar);
            }
            ...
            {//Wanted Level Stuff
                ...
                if (buttons::Int("Level", &feature::local::WantedLevel::wantedLevelIndex, 0, 5, 1))
